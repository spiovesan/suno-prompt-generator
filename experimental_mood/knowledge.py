"""
Knowledge base for Suno Prompt Studio refiner.
...
JAZZ_GUIDELINES = {
    "general": """
## Jazz Prompt Best Practices

Key principles for jazz quartet prompts:
1. Guitar is ALWAYS the lead melodic voice
2. Piano provides harmonic support (comping, voicings)
3. Bass provides foundation (walking, groove)
4. Drums provide rhythmic texture

## Hard Rules:
- No saxophone, brass, or strings
- No artist names (Coltrane, Metheny, etc.)
- No negative terms ("no", "without")
- Guitar must play melody/theme
""",

    "harmony": """
## Jazz Harmony Guidelines

**Chord Progressions (Bracket Tags):**
- [ii-V-I progression] - classic jazz movement
- [tritone substitutions] - chromatic bass movement
- [modal vamp] - single chord exploration
- [complex chord progression] - general jazz complexity

**Extensions:**
- [9th chords] - adds color
- [altered dominants] - tension before resolution
- [quartal voicings] - modern open sound

**Avoid:**
- Simple IVm7-Im7 loops (boring)
- VIm7-IVmaj7 loops (too predictable)
""",

    "styles": """
## Jazz Sub-Styles

**Smooth Jazz:** warm tones, Rhodes, brushed drums
**Bebop:** fast changes, virtuosic lines, walking bass
**Modal Jazz:** sustained harmony, pedal tones, space
**Jazz Fusion:** electric tones, synths allowed, power
**Latin Jazz:** nylon guitar, montuno patterns, percussion
**Cool Jazz:** relaxed, mellow, understated
**Hard Bop:** bluesy, soulful, gospel influences
**Post-Bop:** angular, chromatic, complex
**Acid Jazz:** funky, organ, breakbeats
**ECM Style:** ambient, reverb, minimalist
"""
}
...
def get_jazz_guidelines(aspect: str) -> str:
    """Get jazz-specific guidelines for a specific aspect."""
    return JAZZ_GUIDELINES.get(aspect, JAZZ_GUIDELINES.get("general", "No guidelines found."))
